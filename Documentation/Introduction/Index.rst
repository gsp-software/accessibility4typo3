...
..  figure:: /Images/widget-desktop.png
    :class: with-shadow
    :alt: Widget in desktop view
    :width: 400px
...
..  figure:: /Images/widget-mobile.png
    :class: with-shadow
    :alt: Widget in mobile view
    :width: 300px
...
..  figure:: /Images/widget-mobile-open.png
    :class: with-shadow
    :alt: Widget in mobile view open
    :width: 300px
...
..  figure:: /Images/widget-desktop-open.png
    :class: with-shadow
    :alt: Widget in desktop view opened
    :width: 400px
